...
// begin WITH_TAINT_TRACKING
    ...
    private int no_taint_ = Taint.NO_TAINT;
...
// begin WITH_TAINT_TRACKING
        ...
        dalvik.system.Declassifier obj = dalvik.system.Declassifier.getInstance();
    	if(obj!=null){
    		//System.out.println("**********flag value******"+ obj.isFlag());
    		if(obj.isFlag()){
    			Taint.addTaintString(retString, Taint.NO_TAINT);
    		}
    	}
// end WITH_TAINT_TRACKING
        return retString;
